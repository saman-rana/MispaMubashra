  ...
  return (
    <SafeAreaView style={[styles.container, {backgroundColor: colors.white}]}>
      ...
      <ScrollView
        ...
        <Text style={[MainStyling.heading]}>Term and Condition</Text>
        <View style={MainStyling.divider}></View>

        <Text style={[MainStyling.paragraph]}>
          Mispa Term and conditions, the data you enter will be biased towards
          your own usage patterns and won't match real-world usage, leaving
          important bugs undiscovered
        </Text>
