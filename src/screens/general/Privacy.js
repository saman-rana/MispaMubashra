  ...
  return (
    <SafeAreaView style={[styles.container, {backgroundColor: colors.white}]}>
      ...
      <ScrollView
        ...
        <Text style={[MainStyling.heading]}>Privacy Policy</Text>
        <View style={MainStyling.divider}></View>

        <Text style={[MainStyling.paragraph]}>
          Mispa Privacy, the data you enter will be biased towards your own
          usage patterns and won't match real-world usage, leaving important
          bugs undiscovered
        </Text>
